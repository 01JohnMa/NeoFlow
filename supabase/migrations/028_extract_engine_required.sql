-- ============================================================
-- MIGRATION 028: Extract 成功结果必须带 engine
-- ============================================================
-- 027 已可能在环境中执行，使用前向迁移而不是修改已记录 checksum 的文件。
-- 成功交卷只接受 JSON 对象形式的 engine；SQL NULL 和 JSON null 都拒绝。
-- ============================================================
...
SELECT '028: Extract engine 必填约束就绪' AS message;
