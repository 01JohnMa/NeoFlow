---
name: 解耦照明与质量管理中心上传逻辑
overview: 重构 Upload.tsx，解耦照明系统和质量管理中心的上传逻辑。照明系统始终显示两文件合并上传，质量管理中心使用单文件自动识别，两者逻辑独立互不影响。
todos:
...
**问题**：当任何一环数据获取失败，整个界面就会错乱。照明系统和质量管理中心的逻辑混在一起，互相影响。
