...
### 业务指标
- **覆盖场景**：成功支持质量管理中心（3种单据）和照明系统（合并报告）两大核心场景。
...
- **业务场景落地**：
    *   **质量管理中心**：检测报告（原测试单/检验报告统一）、快递单、抽样单已上线。
