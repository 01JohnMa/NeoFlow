...
function Harness() {
  ...
  return <div className="flex h-screen bg-bg-primary text-text-primary">
    <aside style={{ width: 240 }} className="shrink-0 border-r border-border-default p-6">NeoFlow · 编辑器交互测试</aside>
    <div className="min-w-0 flex-1"><header style={{ height: 64 }} className="border-b border-border-default px-6 py-5">配置管理</header>
